...
var QuestView = Backbone.View.extend({
    ...
    initialize: function(){
        var script_init_settings = ''.concat('var QuestModuleInitSettings = { css_inject_url : \'', config.css_inject_url, '?v=' + config.cache_bust_version,
