...
var QuestView = Backbone.View.extend({
    ...
    initialize: function(){
        ...
        var script_init_settings = ''.concat('var QuestModuleInitSettings = { ',
            'css_inject_url : \'', config.css_inject_path, '/style_inject.css?v=' + config.cache_bust_version, '\', ',
            'css_inject_ie_fix_url: \'', config.css_inject_path, '/style_inject_iefix.css?v=' + config.cache_bust_version, '\', ',
...
function EBCallBackMessageReceived(msg, data) {
    ...
    switch(msg){
        case 'injection_initialized' : {
            ...
            window.QuestButtonView.update_toolbar_button();
            break;
        }
        case 'url_msg': {
